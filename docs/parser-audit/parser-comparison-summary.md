...
| MySQL full-grammar v5_7 sample-data | 38 | 32 / 6 | 331 | 294 | 244 | 0 |
| MySQL full-grammar v8_0 sample-data | 38 | 32 / 6 | 361 | 298 | 248 | 0 |
| PostgreSQL token-event root sample-data | 38 | 32 / 6 | 366 | 256 | 248 | 0 |
| PostgreSQL full-grammar v16 sample-data | 38 | 32 / 6 | 366 | 257 | 248 | 0 |
| PostgreSQL full-grammar v17 sample-data | 38 | 32 / 6 | 366 | 257 | 248 | 0 |
| PostgreSQL full-grammar v18 sample-data | 38 | 32 / 6 | 366 | 256 | 248 | 0 |
| Oracle token-event root sample-data | 38 | 32 / 6 | 365 | 247 | 248 | 0 |
| Oracle full-grammar v12c sample-data | 38 | 32 / 6 | 365 | 247 | 248 | 0 |
| Oracle full-grammar v19c sample-data | 38 | 32 / 6 | 365 | 247 | 248 | 0 |
| Oracle full-grammar v21c sample-data | 38 | 32 / 6 | 365 | 247 | 248 | 0 |
| Oracle full-grammar v26ai sample-data | 38 | 32 / 6 | 365 | 247 | 248 | 0 |
| SQL Server token-event root sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 |
| SQL Server full-grammar v2016 sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 |
| SQL Server full-grammar v2017 sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 |
| SQL Server full-grammar v2019 sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 |
| SQL Server full-grammar v2022 sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 |
| SQL Server full-grammar v2025 sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 |
...
- PostgreSQL token-event and PostgreSQL full-grammar are close on sample-data lineage. v16/v17 have one extra non-trivial self-update lineage from the version-specific `pg16_generated_margin_demo.sales_amount = target.sales_amount * 1.05` SQL; that is an expected asset/version delta, not a parser false positive.
- Oracle token-event and the four full-grammar profiles now match on direct `Rel/Lin/Name` counts and on the audited direct relationship set. Token-event supports `OPEN cursor FOR SELECT` and `LISTAGG ... WITHIN GROUP`; full-grammar traverses SELECT-list scalar subqueries and rejects function-to-function expressions as direct column equality.
...
| MySQL full-grammar v5_7 sample-data | 38 | 32 / 6 | 331 | 294 | 244 | 0 | 1588 | 75 | 1098 |
| MySQL full-grammar v8_0 sample-data | 38 | 32 / 6 | 361 | 298 | 248 | 0 | 1950 | 64 | 1304 |
| PostgreSQL token-event root sample-data | 38 | 32 / 6 | 366 | 256 | 248 | 0 | 2030 | 61 | 1324 |
| PostgreSQL full-grammar v16 sample-data | 38 | 32 / 6 | 366 | 257 | 248 | 0 | 2030 | 61 | 1324 |
| PostgreSQL full-grammar v17 sample-data | 38 | 32 / 6 | 366 | 257 | 248 | 0 | 2030 | 61 | 1324 |
| PostgreSQL full-grammar v18 sample-data | 38 | 32 / 6 | 366 | 256 | 248 | 0 | 2030 | 61 | 1324 |
| Oracle token-event root sample-data | 38 | 32 / 6 | 365 | 247 | 248 | 0 | 2001 | 53 | 1316 |
| Oracle full-grammar v12c sample-data | 38 | 32 / 6 | 365 | 247 | 248 | 0 | 2001 | 53 | 1316 |
| Oracle full-grammar v19c sample-data | 38 | 32 / 6 | 365 | 247 | 248 | 0 | 2001 | 53 | 1316 |
| Oracle full-grammar v21c sample-data | 38 | 32 / 6 | 365 | 247 | 248 | 0 | 2001 | 53 | 1316 |
| Oracle full-grammar v26ai sample-data | 38 | 32 / 6 | 365 | 247 | 248 | 0 | 2001 | 53 | 1316 |
| SQL Server token-event root sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 | 1606 | 130 | 1054 |
| SQL Server full-grammar v2016 sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 | 1606 | 130 | 1054 |
| SQL Server full-grammar v2017 sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 | 1606 | 130 | 1054 |
| SQL Server full-grammar v2019 sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 | 1606 | 130 | 1054 |
| SQL Server full-grammar v2022 sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 | 1606 | 130 | 1054 |
| SQL Server full-grammar v2025 sample-data | 38 | 32 / 6 | 337 | 310 | 245 | 0 | 1606 | 130 | 1054 |
...
| --- | --- | --- | --- |
| MySQL token-event vs MySQL full-grammar on broad sample-data | both `361 / 298 / 248` | `AUDITED_SET_MATCH` | Direct relationship fingerprints, exact lineage fingerprints, and direct naming ids match between root token-event and v8_0 full. |
| PostgreSQL token-event vs PostgreSQL full-grammar on broad sample-data | root/v18 `366 / 256`; v16/v17 `366 / 257` | `EXPECTED_VERSION_DELTA` | v16/v17 carry one additional non-trivial self-update lineage in version-specific SQL. |
| Oracle full-grammar vs Oracle token-event on broad sample-data | all profiles `365 / 247 / 248` | `AUDITED_SET_MATCH` | Relationship, lineage flow/transform, and naming id sets match across root and all four full profiles. |
| SQL Server full-grammar vs token-event on broad sample-data | all profiles `337 / 310 / 245` | `AUDITED_SET_MATCH` | Direct relationship fingerprints, exact lineage fingerprints, and direct naming ids match across root and all five full profiles. |
