# full-grammar Expression Transform Compatibility Audit

This file records expression-transform differences that were exposed while
hardening full-grammar output and resolved by manual review.

Production token-event output, versioned full-grammar output, and correctness
