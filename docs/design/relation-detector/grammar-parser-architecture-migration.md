...
本文同时记录目标状态和实施状态。grammar 所有权、Script Framer、当时的 SPI v4（现已由 SPI v6 取代）、正确 Grammar
...
| Script Framer 与当时的 SPI v4 | 已实施；当前公开契约为 SPI v6 | framing/SPI architecture tests |
