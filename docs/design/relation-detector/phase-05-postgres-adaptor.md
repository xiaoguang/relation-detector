...
| --- | ---: | --- | ---: | --- |
| `test-fixtures/correctness/postgres` | 111 | token-event baseline | relation 1428 / lineage 424 / Rel NAMING_MATCH 397 / top-level namingEvidence 472 | 历史兼容基线，不移动到某个大版本目录。 |
| `test-fixtures/correctness/postgres/v16` | 111 | `parserMode: full-grammar`, `grammarProfile: postgresql/16` | relation 1479 / lineage 435 / Rel NAMING_MATCH 418 / top-level namingEvidence 494 | PostgreSQL 16.x 严格语法 golden。 |
| `test-fixtures/correctness/postgres/v17` | 113 | `parserMode: full-grammar`, `grammarProfile: postgresql/17` | relation 1482 / lineage 448 / Rel NAMING_MATCH 419 / top-level namingEvidence 495 | 加入 PostgreSQL 17 专属 SQL/JSON、`JSON_TABLE`、MERGE 扩展 fixture。 |
| `test-fixtures/correctness/postgres/v18` | 114 | `parserMode: full-grammar`, `grammarProfile: postgresql/18` | relation 1482 / lineage 447 / Rel NAMING_MATCH 418 / top-level namingEvidence 494 | 加入 PostgreSQL 18 `RETURNING old/new`、virtual generated column、temporal constraint fixture。 |
