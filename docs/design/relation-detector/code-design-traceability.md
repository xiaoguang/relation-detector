...
| relationship 条件与 provenance merge | PARTIAL | 完整 guard identity、conditional/unconditional summary 与 polymorphic 计算已通过 focused tests；剩余 EV-03 要求 grouped evidence 顶层只保留所有 observation 一致的 consensus attributes。 |
