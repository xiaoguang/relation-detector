...
- `full-grammer`：版本化完整 grammar 链路。MySQL 8.0 与 PostgreSQL 16/17/18 的 full-grammer module 由 adaptor 提供，解析树 visitor 直接生成同一套结构事件。
...
- PostgreSQL `16.5` 使用 `postgresql-16`，`17.5` 使用 `postgresql-17`，`18.1` 使用 `postgresql-18`。
