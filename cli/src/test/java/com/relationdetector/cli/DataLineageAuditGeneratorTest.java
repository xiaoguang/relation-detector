...
class DataLineageAuditGeneratorTest {
    ...
    void generatedAuditClassifiesLineageFixtureCoverage() throws Exception {
        ...
        assertTrue(markdown.contains("| TOTAL | 1194 |"));
        ...
        assertTrue(markdown.contains("| NOT_APPLICABLE | 765 |"));
        ...
        assertTrue(markdown.contains("sqlserver2025-sample-data-full-02-procedures-13-erp-deep-scenario-procedures-sql"));
        assertTrue(markdown.contains(
