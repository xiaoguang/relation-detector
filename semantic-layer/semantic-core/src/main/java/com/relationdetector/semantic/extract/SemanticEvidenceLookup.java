 ...
 */
interface SemanticEvidenceLookup {
    boolean containsReference(String reference);

    Optional<JsonNode> findEvidence(String reference);

    static SemanticEvidenceLookup from(SemanticEvidenceStore store) {
        if (store == null) {
