 ...
 */
public final class DiskUnionFind implements AutoCloseable {
    private static final int WIDTH = Integer.BYTES;
    private final RandomAccessFile parents;
    private final int size;

    public DiskUnionFind(Path path, int size) throws IOException {
        if (size < 0) {
    ...
    public void union(int left, int right) throws IOException {
