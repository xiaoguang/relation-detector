 ...
 */
public final class SemanticRequestBundleCanonicalDigest {
    ...
    public static String bundleSha256(JsonNode descriptor, Map<String, SectionDigest> sections) {
    ...
    public static Map<String, SectionDigest> immutable(Map<String, SectionDigest> sections) {
    ...
    public record SectionDigest(long count, String sha256) {
