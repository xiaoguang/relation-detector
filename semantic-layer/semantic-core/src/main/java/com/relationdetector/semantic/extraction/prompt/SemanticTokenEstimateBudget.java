 ...
 */
public final class SemanticTokenEstimateBudget {
    ...
    public SemanticTokenEstimateBudget(int maxEstimatedTokens) {
    ...
    public void add(char[] value, int offset, int length) {
    ...
    public JsonNode readValue(JsonParser parser, ObjectMapper mapper, String label) {
    ...
    public void requireCompleteCodePoint(String label) {
    ...
    public void requireMayFitUtf8Bytes(long bytes) {
    ...
    public int maximumSingleStringLength() {
