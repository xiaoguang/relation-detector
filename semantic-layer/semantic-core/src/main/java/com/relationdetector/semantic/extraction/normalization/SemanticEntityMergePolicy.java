 ...
 */
public final class SemanticEntityMergePolicy {
    private static final String PHYSICAL_PLACEHOLDER = "PHYSICAL_ENTITY";

    private SemanticEntityMergePolicy() {
    }

    public static ObjectNode merge(List<ObjectNode> variants) {
    ...
    public static boolean canMerge(List<ObjectNode> variants) {
        if (variants == null || variants.isEmpty()) {
            throw new IllegalArgumentException("semantic entity variants are required");
        }
    ...
    public static List<ObjectNode> reconciliationVariants(List<ObjectNode> variants) {
        if (variants == null || variants.isEmpty()) {
            throw new IllegalArgumentException("semantic entity variants are required");
        }
        validatePhysicalIdentity(variants);
