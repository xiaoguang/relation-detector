 ...
 */
final class SemanticCanonicalIdentity {
    private SemanticCanonicalIdentity() {
    }

    static EntityIdentity entity(
            String physicalName,
            String name,
            String machineType,
            String type,
    ...
    static String event(String eventCandidateRef) {
    ...
    static String review(String targetRef, String targetSection, String type) {
        return StableSemanticId.of("review", text(targetRef), text(targetSection), text(type));
    }

    static String edge(String prefix, String source, String target, String type) {
        return StableSemanticId.of(
