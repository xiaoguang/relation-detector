 ...
 */
final class SemanticReconstructedEvidenceLookup implements SemanticEvidenceLookup, AutoCloseable {
    ...
    SemanticReconstructedEvidenceLookup(Path bundle, Path workspace) {
