...
import com.relationdetector.semantic.evidence.SemanticReferenceClosureStore;

import com.relationdetector.semantic.evidence.SemanticGraphRecordStore;

import com.relationdetector.semantic.evidence.SemanticEndpointEvidenceStore;
 ...
 */
final class SemanticKgStore implements AutoCloseable {
    ...
    SemanticKgStore(SemanticGraphRecordStore graph, Path workspace) {
