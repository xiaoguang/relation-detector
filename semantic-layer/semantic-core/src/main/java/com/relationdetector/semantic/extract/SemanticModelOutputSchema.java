 ...
 * validation.
 */
final class SemanticModelOutputSchema {
    static final String EXTRACTION_FILE = "semantic-extraction-output-schema.json";
    static final String RECONCILIATION_FILE = "semantic-reconciliation-output-schema.json";
