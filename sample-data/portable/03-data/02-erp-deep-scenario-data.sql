...
INSERT INTO payment_receipts (id, receipt_no, receipt_type, party_type, party_id, account_id,
    receipt_date, amount, currency, status, handled_by)
VALUES
(9010, 'PR-SEM-9010', 'customer_receipt', 'customer', 2, 1, '2026-02-18', 18000.00, 'CNY', 'confirmed', 39),
(9011, 'PR-SEM-9011', 'customer_receipt', 'customer', 3, 1, '2026-02-19', 16880.00, 'CNY', 'confirmed', 39),
(9012, 'PR-SEM-9012', 'customer_receipt', 'customer', 5, 1, '2026-03-05', 3000.00, 'CNY', 'confirmed', 40),
(9013, 'PR-SEM-9013', 'customer_receipt', 'customer', 4, 1, '2026-03-18', 0.00, 'CNY', 'draft', 40);
...
INSERT INTO cashier_journals (id, journal_no, journal_date, account_id, cashier_id, journal_type,
    amount, counterparty, reference_type, reference_id, status)
VALUES
(9010, 'CJ-SEM-9010', '2026-02-18', 1, 39, 'receipt', 18000.00, '华东商贸客户', 'sales_order', 9010, 'confirmed'),
(9011, 'CJ-SEM-9011', '2026-02-19', 1, 39, 'receipt', 16880.00, '女装零售客户', 'sales_order', 9011, 'confirmed'),
(9012, 'CJ-SEM-9012', '2026-03-05', 1, 40, 'receipt', 3000.00, '小批量客户', 'sales_order', 9013, 'confirmed'),
(9013, 'CJ-SEM-9013', '2026-03-18', 1, 40, 'receipt', 0.00, '账期客户', 'sales_order', 9012, 'draft');
