...
WITH supplier_return_stats AS (
    ...
    WHERE pr.return_date >= CURRENT_DATE - INTERVAL '12 months'
...
supplier_inspection_stats AS (
    ...
    WHERE ir.inspection_date >= CURRENT_DATE - INTERVAL '12 months'
    GROUP BY pb.supplier_id
)
SELECT
...
WITH inventory_movement AS (
    ...
    WHERE it.created_at >= CURRENT_DATE - INTERVAL '6 months'
