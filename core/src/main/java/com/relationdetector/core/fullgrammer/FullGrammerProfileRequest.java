...
/** Inputs used to select a versioned full-grammer profile. */
public record FullGrammerProfileRequest(
    ...
    public static final class Builder {
        ...
        public FullGrammerProfileRequest build() {
            return new FullGrammerProfileRequest(
                    databaseType,
                    configuredProfile,
                    configuredVersion,
