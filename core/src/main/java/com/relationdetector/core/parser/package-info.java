 ...
 * 选择 full-grammer 或 token-event，并把结构化结果交给 relationship / DDL
 * 语义抽取。fallback 只发生在这里，不在 full-grammer event 生成层混入 token-event
 * 事件。
 *
 * <p>EN: SQL/DDL parser selection and runner layer. It selects full-grammer or
 ...
 * happens here, not inside full-grammer event generation.
 */
