 ...
 * token-event 事件来源层。
 *
 * <p>CN: 本包基于 tolerant ANTLR lexer/parser 与 token stream 生成统一
 ...
 * records from tolerant ANTLR lexer/parser tokens and is the official fallback
 * when no full-grammer profile is selected. It owns structure extraction, not
