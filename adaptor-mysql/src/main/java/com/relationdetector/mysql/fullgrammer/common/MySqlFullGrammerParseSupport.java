 ...
 * rules; this support class owns error listener setup, SQL delimiter
 * normalization, and visible-token extraction.
 */
public final class MySqlFullGrammerParseSupport {
    ...
    public static <L extends Lexer, P extends Parser> FullGrammerSqlParse parseSql(
        ...
        try {
            L lexer = lexerFactory.apply(CharStreams.fromString(
                    MySqlFullGrammerSqlNormalizer.normalizeClientDelimiters(sql)));
