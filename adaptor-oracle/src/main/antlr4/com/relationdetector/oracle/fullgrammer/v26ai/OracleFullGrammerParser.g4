...
vectorDataType
    : VECTOR (LPAREN NUMBER (COMMA identifier)? RPAREN)?
    ;
...
sqlToken
    ...
    | ADD | CONSTRAINT
    | FOREIGN | KEY | REFERENCES | PRIMARY | UNIQUE | INDEX | CONCURRENTLY | ONLY
    | INCLUDE | TABLESPACE | MATERIALIZED | MEMOPTIMIZE | READ | SQL_MACRO | VECTOR | ROWS | TABLESAMPLE | LATERAL | ORDINALITY | OVER
    | IDENTIFIER | QUOTED_IDENTIFIER | STRING_LITERAL | DOLLAR_QUOTED_STRING | NUMBER
