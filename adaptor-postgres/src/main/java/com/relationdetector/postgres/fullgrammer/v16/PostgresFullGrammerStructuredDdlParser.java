...
/**
 * PostgreSQL 16 full-grammer DDL parser binding.
 *
 * <p>CN: 只绑定 PostgreSQL 16 generated lexer/parser 和 v16 DDL collector；公共
 * parse 生命周期在 common abstract parser 中。
 *
 * <p>EN: PostgreSQL 16 full-grammer DDL parser binding. It only wires the
 * PostgreSQL 16 generated lexer/parser and DDL collector; the shared parse
