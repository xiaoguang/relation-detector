...
/**
 * PostgreSQL 17 full-grammer SQL parser binding.
 *
 * <p>CN: 只绑定 PostgreSQL 17 generated lexer/parser 和 v17 typed visitor；公共
 * parse 生命周期在 common abstract parser 中。
 *
 * <p>EN: PostgreSQL 17 full-grammer SQL parser binding. It only wires the
 * PostgreSQL 17 generated lexer/parser and typed visitor; the shared parse
