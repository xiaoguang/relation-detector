...
/**
 * PostgreSQL 18 full-grammer DDL parser binding.
 *
 * <p>CN: 只绑定 PostgreSQL 18 generated lexer/parser 和 v18 DDL collector；公共
 * parse 生命周期在 common abstract parser 中。v18 collector 保留 temporal constraint
 * 的版本专属列过滤。
 *
 * <p>EN: PostgreSQL 18 full-grammer DDL parser binding. It only wires the
 * PostgreSQL 18 generated lexer/parser and DDL collector; the shared parse
 * lifecycle lives in the common abstract parser. The v18 collector keeps the
 * version-specific temporal-constraint column filtering.
 */
