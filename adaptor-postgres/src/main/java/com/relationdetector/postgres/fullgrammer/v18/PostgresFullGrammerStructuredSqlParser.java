...
/**
 * PostgreSQL 18 full-grammer SQL parser binding.
 *
 * <p>CN: 只绑定 PostgreSQL 18 generated lexer/parser 和 v18 typed visitor；公共
 * parse 生命周期在 common abstract parser 中。
 *
 * <p>EN: PostgreSQL 18 full-grammer SQL parser binding. It only wires the
 * PostgreSQL 18 generated lexer/parser and typed visitor; the shared parse
