grammar PostgresFullGrammerRoutineBodySql;

/*
 * PostgreSQL full-grammer routine-body structural grammar.
 *
 ...
 * DELETE ... WHERE. This grammar is local to full-grammer and is used only to parse PL/pgSQL routine bodies after the versioned full-grammer parser has parsed the outer CREATE FUNCTION/PROCEDURE statement.
 */
