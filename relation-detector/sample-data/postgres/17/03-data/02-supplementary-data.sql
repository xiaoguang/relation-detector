...
(1, 1, '入库外观与功能抽检', '[{"item":"appearance","required":"no scratch"},{"item":"function","required":"power on"}]'::jsonb, 'gb2828', 20, 1.00, 'active'),
(2, 2, '包装完整性抽检', '[{"item":"package","required":"sealed"}]'::jsonb, 'fixed', 10, 1.50, 'active');
...
(1, '采购审批流', 'PURCHASE_APPROVAL', 'purchase_order', '采购订单金额分级审批', TRUE),
(2, '库存调整审批流', 'INVENTORY_ADJUST_APPROVAL', 'stocktake', '库存盘点差异审批', TRUE);
...
(1, 1, '部门经理审批', 1, 'department_manager', NULL, 'single', 24, TRUE),
(2, 1, '财务复核', 2, 'role', 6, 'single', 48, TRUE),
(3, 2, '仓储经理审批', 1, 'employee', 42, 'single', 24, FALSE);
