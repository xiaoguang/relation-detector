...
(1, 1, 'BOOK-CNY-2026', '华东人民币主账套', 'CNY', 1, TRUE, 'active'),
(2, 2, 'BOOK-CNY-2026', '华南人民币主账套', 'CNY', 1, TRUE, 'active');
...
(1, 'registered', '采购中心', '021-60000001', '上海市', '上海市', '浦东新区', '世纪大道100号', '200120', TRUE),
(1, 'shipping', '上海仓收货组', '021-60000002', '上海市', '上海市', '闵行区', '申虹路88号', '201100', FALSE),
(2, 'shipping', '杭州门店', '0571-60000003', '浙江省', '杭州市', '西湖区', '文三路66号', '310012', TRUE);
...
(1, 'registered', '供应商财务', '0755-70000001', '广东省', '深圳市', '南山区', '科技园路1号', '518000', TRUE),
(1, 'warehouse', '供应商发货组', '0755-70000002', '广东省', '深圳市', '宝安区', '物流园9号', '518100', FALSE),
(2, 'warehouse', '华东发货组', '0512-70000003', '江苏省', '苏州市', '工业园区', '星湖街12号', '215000', TRUE);
...
(1, 'D', '白班', '08:30:00', '17:30:00', 8.00, FALSE),
(2, 'N', '夜班', '20:30:00', '05:30:00', 8.00, TRUE);
...
INSERT INTO leave_records (employee_id, leave_type, start_date, end_date, days, reason, status, approved_by, approved_at) VALUES
(9, 'annual', '2026-02-03', '2026-02-05', 3.0, '春节后调休', 'approved', 5, '2026-01-28 10:30:00'),
(30, 'sick', '2026-02-12', '2026-02-12', 1.0, '门诊检查', 'pending', NULL, NULL);
...
VALUES
(9001, 9001, 8, '2026-02-10', 899.00, TRUE, 9001, '客户确认寄售消耗并转销售结算');
