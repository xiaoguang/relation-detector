...
import com.relationdetector.sqlserver.fullgrammer.v2017.SqlServerFullGrammerParser.*;

final class SqlServer2017ParseTreeAdapter extends AbstractSqlServerParseTreeAdapter {
    SqlServer2017ParseTreeAdapter() {
        super(
