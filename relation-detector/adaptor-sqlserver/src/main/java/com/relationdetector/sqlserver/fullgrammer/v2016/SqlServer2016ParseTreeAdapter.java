...
import com.relationdetector.sqlserver.fullgrammer.common.AbstractSqlServerParseTreeAdapter;
import com.relationdetector.sqlserver.fullgrammer.v2016.SqlServerFullGrammerParser.*;

final class SqlServer2016ParseTreeAdapter extends AbstractSqlServerParseTreeAdapter {
    SqlServer2016ParseTreeAdapter() {
        super(
                role(Role.COLUMN_REFERENCE, Full_column_nameContext.class),
                role(Role.CASE_EXPRESSION, Case_expressionContext.class),
                role(Role.CASE_SWITCH_SECTION, Switch_sectionContext.class),
                role(Role.CASE_SEARCH_SECTION, Switch_search_condition_sectionContext.class),
                ...
                role(Role.SELECT_TARGET_ITEM, Select_list_elemContext.class),
                role(Role.FROM_CLAUSE, Table_sourcesContext.class),
                role(Role.TABLE_SOURCE_ITEM, Table_source_itemContext.class),
                role(Role.EXPRESSION, ExpressionContext.class),
                role(Role.ROOT_EXPRESSION, ExpressionContext.class),
                role(Role.CONTROL_SCOPE, Join_onContext.class, Search_conditionContext.class,
                        Group_by_itemContext.class),
                role(Role.SQL_CLAUSE, Sql_clausesContext.class),
                role(Role.COMMON_TABLE_EXPRESSION, Common_table_expressionContext.class),
                role(Role.QUERY_SPECIFICATION, Query_specificationContext.class),
                role(Role.JOIN_ON, Join_onContext.class), role(Role.CROSS_JOIN, Cross_joinContext.class),
                role(Role.APPLY, Apply_Context.class), role(Role.PREDICATE, PredicateContext.class),
                role(Role.INSERT_STATEMENT, Insert_statementContext.class),
                role(Role.UPDATE_STATEMENT, Update_statementContext.class),
                role(Role.MERGE_STATEMENT, Merge_statementContext.class),
                role(Role.DML_TRIGGER, Create_or_alter_dml_triggerContext.class),
                role(Role.CREATE_TABLE, Create_tableContext.class), role(Role.ALTER_TABLE, Alter_tableContext.class),
                role(Role.CREATE_INDEX, Create_indexContext.class), role(Role.FULL_TABLE_NAME, Full_table_nameContext.class),
                role(Role.TABLE_ALIAS, As_table_aliasContext.class), role(Role.COLUMN_ALIAS, As_column_aliasContext.class),
                role(Role.IDENTIFIER, Id_Context.class),
                role(Role.COMPARISON_OPERATOR, Comparison_operatorContext.class),
                role(Role.SELECT_STATEMENT, Select_statementContext.class), role(Role.SELECT_LIST, Select_listContext.class),
                role(Role.TABLE_SOURCES, Table_sourcesContext.class), role(Role.SEARCH_CONDITION, Search_conditionContext.class),
                role(Role.DERIVED_TABLE, Derived_tableContext.class), role(Role.ROWSET_FUNCTION, Rowset_functionContext.class),
                role(Role.OPEN_XML, Open_xmlContext.class), role(Role.OPEN_JSON, Open_jsonContext.class),
                role(Role.CHANGE_TABLE, Change_tableContext.class), role(Role.NODES_METHOD, Nodes_methodContext.class),
                role(Role.TABLE_SOURCE, Table_sourceContext.class), role(Role.DDL_OBJECT, Ddl_objectContext.class),
                role(Role.INSERT_COLUMN_LIST, Insert_column_name_listContext.class),
                role(Role.INSERT_VALUE, Insert_statement_valueContext.class), role(Role.WITH_EXPRESSION, With_expressionContext.class),
                role(Role.UPDATE_ELEMENT, Update_elemContext.class), role(Role.COLUMN_LIST, Column_name_listContext.class),
                role(Role.ORDERED_COLUMN_LIST, Column_name_list_with_orderContext.class),
                role(Role.EXPRESSION_LIST, Expression_list_Context.class),
                role(Role.MERGE_UPDATE_ELEMENT, Update_elem_mergeContext.class),
