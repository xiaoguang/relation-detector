...
import com.relationdetector.sqlserver.fullgrammer.v2019.SqlServerFullGrammerParser.*;

final class SqlServer2019ParseTreeAdapter extends AbstractSqlServerParseTreeAdapter {
    SqlServer2019ParseTreeAdapter() {
        super(
