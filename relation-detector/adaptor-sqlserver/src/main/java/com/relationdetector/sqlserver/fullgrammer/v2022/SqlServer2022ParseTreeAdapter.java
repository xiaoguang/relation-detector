...
import com.relationdetector.sqlserver.fullgrammer.v2022.SqlServerFullGrammerParser.*;

final class SqlServer2022ParseTreeAdapter extends AbstractSqlServerParseTreeAdapter {
    SqlServer2022ParseTreeAdapter() {
        super(
