...
BEGIN
    ...
    ) risk_snapshot ON ab.user_id = risk_snapshot.user_id
    INNER JOIN global_compliance_policies gcp ON ab.region_code = gcp.region_code
    SET
    ...
    WHERE gcp.policy_status = 'ENFORCED'
