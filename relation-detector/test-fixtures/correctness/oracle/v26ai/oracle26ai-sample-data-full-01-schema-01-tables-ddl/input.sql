...
CREATE TABLE inventory (
    ...
    available_quantity NUMBER(10) GENERATED ALWAYS AS (quantity - locked_quantity) VIRTUAL,
...
CREATE TABLE purchase_requisition_items (
    ...
    amount NUMBER(18,2) GENERATED ALWAYS AS (quantity * estimated_price) VIRTUAL,
    remark VARCHAR2(200),
...
CREATE TABLE purchase_return_items (
    ...
    return_qty NUMBER(10) NOT NULL,
    unit_price NUMBER(12,2) NOT NULL,
    amount NUMBER(18,2) GENERATED ALWAYS AS (return_qty * unit_price) VIRTUAL,
    reason VARCHAR2(200),
...
CREATE TABLE damage_report_items (
    ...
    loss_amount NUMBER(18,2) GENERATED ALWAYS AS (quantity * unit_cost) VIRTUAL,
    reason VARCHAR2(200),
...
CREATE TABLE settlements (
    ...
    unpaid_amount NUMBER(18,2) GENERATED ALWAYS AS (total_amount - settled_amount) VIRTUAL,
