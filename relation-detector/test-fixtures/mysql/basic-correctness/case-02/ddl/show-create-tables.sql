...
-- relation-detector-fixture-table: case_02.biz_bill_item_fact
...
) ENGINE=InnoDB AUTO_INCREMENT=18378921 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='单据明细事实表（高频字段极简版）';

-- relation-detector-fixture-table: case_02.biz_bill_item_fact_old_20260528
CREATE TABLE `biz_bill_item_fact_old_20260528` (
  `factId` bigint NOT NULL AUTO_INCREMENT COMMENT '事实明细ID，语义层生成',
  `tenantId` bigint NOT NULL COMMENT '租户ID，来源: jsh_depot_head.tenant_id / jsh_depot_item.tenant_id',
  `sourceOrderId` bigint NOT NULL COMMENT '主单ID，来源: jsh_depot_head.id',
  `sourceOrderNo` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '单据号，来源: jsh_depot_head.number',
...
-- relation-detector-fixture-table: case_02.biz_bill_item_fact_old_20260616
CREATE TABLE `biz_bill_item_fact_old_20260616` (
  `factId` bigint NOT NULL AUTO_INCREMENT COMMENT '事实明细ID，语义层生成',
  `tenantId` bigint NOT NULL COMMENT '租户ID，来源: jsh_depot_head.tenant_id / jsh_depot_item.tenant_id',
  `sourceOrderId` bigint NOT NULL COMMENT '主单ID，来源: jsh_depot_head.id',
  `sourceOrderNo` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '单据号，来源: jsh_depot_head.number',
...
-- relation-detector-fixture-table: case_02.chat_message
CREATE TABLE `chat_message` (
  ...
  `status` varchar(16) DEFAULT 'done' COMMENT '状态: thinking/querying/done/error',
...
-- relation-detector-fixture-table: case_02.chat_session
...
-- relation-detector-fixture-table: case_02.fe_agent_message
CREATE TABLE `fe_agent_message` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_fe_agent_message_sessionId` (`sessionId`),
...
) ENGINE=InnoDB AUTO_INCREMENT=223 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Agent 消息表';

-- relation-detector-fixture-table: case_02.fe_agent_session
CREATE TABLE `fe_agent_session` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '会话 ID',
  `sessionId` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '会话唯一标识符',
  `userId` int DEFAULT NULL COMMENT '用户 ID',
  `title` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '会话标题',
  `status` enum('active','archived','deleted') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active' COMMENT '会话状态',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UQ_fe_agent_session_sessionId` (`sessionId`),
  KEY `IDX_fe_agent_session_userId` (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=190 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Agent 会话表';

-- relation-detector-fixture-table: case_02.fe_typeorm_migrations
...
-- relation-detector-fixture-table: case_02.jsh_account
...
-- relation-detector-fixture-table: case_02.jsh_account_head
...
-- relation-detector-fixture-table: case_02.jsh_account_item
...
-- relation-detector-fixture-table: case_02.jsh_depot
...
-- relation-detector-fixture-table: case_02.jsh_depot_head
...
) ENGINE=InnoDB AUTO_INCREMENT=3033705 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='单据主表';

-- relation-detector-fixture-table: case_02.jsh_depot_item
CREATE TABLE `jsh_depot_item` (
  ...
  KEY `tenant_id` (`tenant_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9046408 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='单据子表';

-- relation-detector-fixture-table: case_02.jsh_function
...
-- relation-detector-fixture-table: case_02.jsh_in_out_item
...
-- relation-detector-fixture-table: case_02.jsh_location_gps
CREATE TABLE `jsh_location_gps` (
  ...
  `link_code` varchar(50) DEFAULT NULL COMMENT '编码',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_supplier_only` (`val_supplier_id`),
  UNIQUE KEY `uk_org_only` (`val_org_id`),
  UNIQUE KEY `uk_depot_only` (`val_depot_id`),
  KEY `idx_tenant_id` (`tenant_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=306 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

-- relation-detector-fixture-table: case_02.jsh_log
...
-- relation-detector-fixture-table: case_02.jsh_material
...
-- relation-detector-fixture-table: case_02.jsh_material_attribute
...
-- relation-detector-fixture-table: case_02.jsh_material_category
...
-- relation-detector-fixture-table: case_02.jsh_material_current_stock
...
-- relation-detector-fixture-table: case_02.jsh_material_extend
...
-- relation-detector-fixture-table: case_02.jsh_material_initial_stock
...
-- relation-detector-fixture-table: case_02.jsh_material_property
...
-- relation-detector-fixture-table: case_02.jsh_msg
...
-- relation-detector-fixture-table: case_02.jsh_orga_user_rel
...
-- relation-detector-fixture-table: case_02.jsh_organization
...
-- relation-detector-fixture-table: case_02.jsh_person
...
-- relation-detector-fixture-table: case_02.jsh_platform_config
...
-- relation-detector-fixture-table: case_02.jsh_role
...
-- relation-detector-fixture-table: case_02.jsh_sequence
...
-- relation-detector-fixture-table: case_02.jsh_serial_number
...
-- relation-detector-fixture-table: case_02.jsh_supplier
...
-- relation-detector-fixture-table: case_02.jsh_sys_dict_data
...
-- relation-detector-fixture-table: case_02.jsh_sys_dict_type
...
-- relation-detector-fixture-table: case_02.jsh_system_config
...
-- relation-detector-fixture-table: case_02.jsh_temp_category_affinity
CREATE TABLE `jsh_temp_category_affinity` (
  ...
  `rule_desc` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '规则描述',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- relation-detector-fixture-table: case_02.jsh_temp_category_pdf
CREATE TABLE `jsh_temp_category_pdf` (
  `id` bigint NOT NULL COMMENT '品类ID',
  `name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '品类名称',
  `weight` int DEFAULT '10' COMMENT '采样权重',
  `cdf_end` decimal(10,4) DEFAULT NULL COMMENT '累积分布终点',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- relation-detector-fixture-table: case_02.jsh_temp_day_pdf
CREATE TABLE `jsh_temp_day_pdf` (
  ...
  `remark` varchar(100) DEFAULT NULL COMMENT '节日名称',
  PRIMARY KEY (`day_date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='模拟器-全动态年度日历权重表';

-- relation-detector-fixture-table: case_02.jsh_temp_hour_pdf
...
-- relation-detector-fixture-table: case_02.jsh_temp_mock_batch_results
CREATE TABLE `jsh_temp_mock_batch_results` (
  ...
  `status` varchar(10) COLLATE utf8mb4_general_ci NOT NULL COMMENT '执行状态: SUCCESS / ERROR',
  `order_id` bigint DEFAULT NULL COMMENT '生成的真实零售出库单ID',
  `bill_no` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '生成的真实单据编号(LSCK...)',
  `mock_time` datetime DEFAULT NULL COMMENT '单据落地的绝对历史模拟时钟',
  `operator` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '触发开单的操作员姓名',
  `item_count` int DEFAULT '0' COMMENT '单据内包含的货品行丰富度',
  `total_amount` decimal(24,6) DEFAULT '0.000000' COMMENT '单据最终价税合计总金额',
  `remark` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '核心开单引擎回传的断言日志描述',
  PRIMARY KEY (`id`),
  KEY `idx_audit_month` (`mock_time`) USING BTREE COMMENT '用于最终大盘按月、按年进行财务报表聚合计算的性能优化索引'
) ENGINE=InnoDB AUTO_INCREMENT=189 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='模拟器-全自动计划消耗回执物理流水表(千万级容量底池)';

-- relation-detector-fixture-table: case_02.jsh_temp_mock_plan
CREATE TABLE `jsh_temp_mock_plan` (
  ...
  `mock_timestamp_str` varchar(20) COLLATE utf8mb4_general_ci NOT NULL COMMENT '模拟开单绝对时间戳串 (格式: YYYY-MM-DD HH:ii:ss)',
  `bill_no_str` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '一阶段预分配并完全固化落地好的 LSCK 单号 (彻底避免大盘重置回卷重号)',
...
) ENGINE=InnoDB AUTO_INCREMENT=1000039081 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='模拟器-全年度开单计划流水表(全局固化单号防重版)';

-- relation-detector-fixture-table: case_02.jsh_temp_org_pdf
CREATE TABLE `jsh_temp_org_pdf` (
  ...
  `remark` varchar(100) DEFAULT NULL COMMENT '门店简称备注',
  PRIMARY KEY (`org_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='模拟器-机构概率分布配置表';

-- relation-detector-fixture-table: case_02.jsh_tenant
...
-- relation-detector-fixture-table: case_02.jsh_unit
...
-- relation-detector-fixture-table: case_02.jsh_user
...
-- relation-detector-fixture-table: case_02.jsh_user_business
...
-- relation-detector-fixture-table: case_02.log_bill_sync_detail
CREATE TABLE `log_bill_sync_detail` (
  ...
  PRIMARY KEY (`logId`),
  KEY `idx_sync_batch` (`syncBatchId`),
  KEY `idx_source_item` (`tenantId`,`sourceOrderItemId`)
) ENGINE=InnoDB AUTO_INCREMENT=2686654 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='单据明细同步日志中间表';

-- relation-detector-fixture-table: case_02.ontology
CREATE TABLE `ontology` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_aa733b95416a2be7d0dce878b8` (`ontology_code`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- relation-detector-fixture-table: case_02.ontology_metric
CREATE TABLE `ontology_metric` (
  ...
  `enabled` int NOT NULL DEFAULT '1',
  `metric_sql` longtext COMMENT 'metric sql template',
  `description_bak` varchar(1024) DEFAULT NULL,
  `metric_sql1` longtext COMMENT 'optimized metric sql v1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_15e15406175086eaaf5769117f` (`metric_code`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- relation-detector-fixture-table: case_02.ontology_metric_bak
CREATE TABLE `ontology_metric_bak` (
  ...
  `description` varchar(500) DEFAULT NULL,
  `description1` text COMMENT 'AI选指标描述',
  `input_params_json` text,
  `output_fields_json` text,
  `default_order_by` varchar(200) DEFAULT NULL,
  ...
  KEY `idx_ontology_code` (`ontology_code`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- relation-detector-fixture-table: case_02.ontology_metric_bak_ceil_20260525
...
-- relation-detector-fixture-table: case_02.ontology_property
...
-- relation-detector-fixture-table: case_02.ontology_relation
CREATE TABLE `ontology_relation` (
  ...
  `description_bak` varchar(1024) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_e490fb346e1a9921337c87a381` (`unique_code`)
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- relation-detector-fixture-table: case_02.ontology_rule
CREATE TABLE `ontology_rule` (
  ...
  `description` varchar(1000) DEFAULT NULL COMMENT '规则整体描述',
  `sort_order` int DEFAULT '0' COMMENT '排序',
  `enabled` tinyint DEFAULT '1' COMMENT '启用',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则描述';

-- relation-detector-fixture-table: case_02.ontology_rule_1
CREATE TABLE `ontology_rule_1` (
  ...
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则描述';

-- relation-detector-fixture-table: case_02.ontology_rule_item
CREATE TABLE `ontology_rule_item` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `rule_code` varchar(100) NOT NULL COMMENT '规则编码，如 restocking_timely_first, restocking_cost_first 等',
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='经营决策规则条目表';

-- relation-detector-fixture-table: case_02.ontology_rule_item_1
CREATE TABLE `ontology_rule_item_1` (
  ...
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='规则描述';

-- relation-detector-fixture-table: case_02.spring_ai_store
...
-- relation-detector-fixture-table: case_02.sys_batch_exec_detail_log
CREATE TABLE `sys_batch_exec_detail_log` (
  ...
  `inbound_number` varchar(50) DEFAULT NULL COMMENT '生成的采购入库单号(对应过程第5步生成的 v_new_number)',
  ...
  `result_status` varchar(10) DEFAULT NULL COMMENT '执行最终状态：SUCCESS 成功 / FAIL 失败',
  `error_message` varchar(500) DEFAULT NULL COMMENT '异常中断或熔断时的致命错误详情(捕获自 MESSAGE_TEXT)',
  PRIMARY KEY (`id`),
  KEY `idx_batch_session` (`batch_session_time`) COMMENT '批次启动时间索引，用于最终一键聚合管理看板数据'
) ENGINE=InnoDB AUTO_INCREMENT=3047 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统跑批事务性能高精度跟踪分析日志表(100%映射单单转换过程各步骤细分耗时)';

-- relation-detector-fixture-table: case_02.user
CREATE TABLE `user` (
  `id` int NOT NULL AUTO_INCREMENT,
