...
-- relation-detector-fixture-table: case_01.GRAPH_THREAD
...
-- relation-detector-fixture-table: case_01.biz_bill_item_fact
CREATE TABLE `biz_bill_item_fact` (
  ...
  UNIQUE KEY `uk_tenant_item` (`tenantId`,`sourceOrderItemId`),
...
) ENGINE=InnoDB AUTO_INCREMENT=12496897 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='单据明细事实表（高频字段极简版）';

-- relation-detector-fixture-table: case_01.biz_sync_progress
CREATE TABLE `biz_sync_progress` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_job_time` (`jobId`,`createdAt`)
) ENGINE=InnoDB AUTO_INCREMENT=12209 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- relation-detector-fixture-table: case_01.chat_message
...
-- relation-detector-fixture-table: case_01.chat_session
...
-- relation-detector-fixture-table: case_01.fe_agent_message
...
-- relation-detector-fixture-table: case_01.fe_agent_session
...
-- relation-detector-fixture-table: case_01.fe_typeorm_migrations
...
-- relation-detector-fixture-table: case_01.jsh_account
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='账户信息';

-- relation-detector-fixture-table: case_01.jsh_account_head
...
-- relation-detector-fixture-table: case_01.jsh_account_item
...
-- relation-detector-fixture-table: case_01.jsh_depot
...
-- relation-detector-fixture-table: case_01.jsh_depot_head
...
) ENGINE=InnoDB AUTO_INCREMENT=2549663 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='单据主表';

-- relation-detector-fixture-table: case_01.jsh_depot_item
CREATE TABLE `jsh_depot_item` (
  ...
  KEY `tenant_id` (`tenant_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12203753 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='单据子表';

-- relation-detector-fixture-table: case_01.jsh_function
...
-- relation-detector-fixture-table: case_01.jsh_in_out_item
...
-- relation-detector-fixture-table: case_01.jsh_location_gps
...
-- relation-detector-fixture-table: case_01.jsh_log
...
-- relation-detector-fixture-table: case_01.jsh_material
...
-- relation-detector-fixture-table: case_01.jsh_material_attribute
...
-- relation-detector-fixture-table: case_01.jsh_material_category
CREATE TABLE `jsh_material_category` (
  ...
  KEY `tenant_id` (`tenant_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='产品类型表';

-- relation-detector-fixture-table: case_01.jsh_material_current_stock
...
-- relation-detector-fixture-table: case_01.jsh_material_extend
...
-- relation-detector-fixture-table: case_01.jsh_material_initial_stock
...
-- relation-detector-fixture-table: case_01.jsh_material_property
...
-- relation-detector-fixture-table: case_01.jsh_mock_batch_log
CREATE TABLE `jsh_mock_batch_log` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '日志主键',
  `code` int NOT NULL COMMENT '返回状态码 (200成功, 500致命错误回滚)',
  `message` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '成功' COMMENT '系统文本或捕获的异常错误',
  `new_id` bigint DEFAULT NULL COMMENT '生成的请购单主表主键ID',
  `number` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '生成的请购单编号',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '日志记录时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_code_message` (`code`,`message`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='模拟请购单专用-批量高频调度持久化物理日志表';

-- relation-detector-fixture-table: case_01.jsh_mock_user_store_pool
CREATE TABLE `jsh_mock_user_store_pool` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `tenant_id` bigint NOT NULL COMMENT '租户ID (支持多租户生产安全隔离)',
  `user_id` bigint NOT NULL COMMENT '活跃用户ID (创建人)',
  `org_id` bigint NOT NULL COMMENT '门店/机构ID',
  `org_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '战略门店编号',
  `org_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '战略门店名称',
  PRIMARY KEY (`id`),
  KEY `idx_tenant_pool_id` (`tenant_id`,`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='模拟请购单专用-战略门店用户池静态配置表';

-- relation-detector-fixture-table: case_01.jsh_msg
...
-- relation-detector-fixture-table: case_01.jsh_orga_user_rel
...
-- relation-detector-fixture-table: case_01.jsh_organization
...
-- relation-detector-fixture-table: case_01.jsh_person
...
-- relation-detector-fixture-table: case_01.jsh_platform_config
...
-- relation-detector-fixture-table: case_01.jsh_role
...
-- relation-detector-fixture-table: case_01.jsh_sequence
...
-- relation-detector-fixture-table: case_01.jsh_serial_number
...
-- relation-detector-fixture-table: case_01.jsh_supplier
...
-- relation-detector-fixture-table: case_01.jsh_sys_dict_data
...
-- relation-detector-fixture-table: case_01.jsh_sys_dict_type
...
-- relation-detector-fixture-table: case_01.jsh_system_config
...
-- relation-detector-fixture-table: case_01.jsh_temp_category_affinity
CREATE TABLE `jsh_temp_category_affinity` (
  `id` int NOT NULL AUTO_INCREMENT,
  `source_cat_id` int DEFAULT NULL COMMENT '触发主品类(A) ID',
  `target_cat_id` int DEFAULT NULL COMMENT '关联从品类(B) ID',
  `link_prob` decimal(4,3) DEFAULT NULL COMMENT '独立连带触发概率',
  `min_ratio` decimal(4,2) DEFAULT NULL COMMENT '数量联动最小比例因子',
  `max_ratio` decimal(4,2) DEFAULT NULL COMMENT '数量联动最大比例因子',
  `rule_desc` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关联规则文本描述',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='品类跨组织亲和力连带矩阵表';

-- relation-detector-fixture-table: case_01.jsh_temp_category_pdf
CREATE TABLE `jsh_temp_category_pdf` (
  ...
  `weight` int DEFAULT '10' COMMENT '采样权重 (决定品类采购基础数量)',
  `cdf_end` decimal(10,4) DEFAULT NULL COMMENT '累积分布终点 (驱动高斯多品类摇号切片)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='核心商品采购频率密度配置表';

-- relation-detector-fixture-table: case_01.jsh_temp_day_pdf
...
-- relation-detector-fixture-table: case_01.jsh_temp_hour_pdf
...
-- relation-detector-fixture-table: case_01.jsh_temp_mock_batch_results
...
) ENGINE=InnoDB AUTO_INCREMENT=21484 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='模拟器-全自动计划消耗回执物理流水表(千万级容量底池)';

-- relation-detector-fixture-table: case_01.jsh_temp_mock_plan
...
) ENGINE=InnoDB AUTO_INCREMENT=3526385 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='模拟器-全年度开单计划流水表(全局固化单号防重版)';

-- relation-detector-fixture-table: case_01.jsh_temp_org_pdf
...
-- relation-detector-fixture-table: case_01.jsh_tenant
...
-- relation-detector-fixture-table: case_01.jsh_unit
...
-- relation-detector-fixture-table: case_01.jsh_user
...
-- relation-detector-fixture-table: case_01.jsh_user_business
...
-- relation-detector-fixture-table: case_01.log_bill_sync_detail
...
-- relation-detector-fixture-table: case_01.ontology
...
-- relation-detector-fixture-table: case_01.ontology_metric
...
-- relation-detector-fixture-table: case_01.ontology_metric_bak
...
-- relation-detector-fixture-table: case_01.ontology_metric_bak_ceil_20260525
...
-- relation-detector-fixture-table: case_01.ontology_property
...
-- relation-detector-fixture-table: case_01.ontology_relation
...
-- relation-detector-fixture-table: case_01.ontology_rule
...
-- relation-detector-fixture-table: case_01.ontology_rule_1
...
-- relation-detector-fixture-table: case_01.ontology_rule_item
...
-- relation-detector-fixture-table: case_01.ontology_rule_item_1
...
-- relation-detector-fixture-table: case_01.spring_ai_store
...
-- relation-detector-fixture-table: case_01.sys_batch_exec_detail_log
...
) ENGINE=InnoDB AUTO_INCREMENT=1024 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='系统跑批事务性能高精度跟踪分析日志表(100%映射单单转换过程各步骤细分耗时)';

-- relation-detector-fixture-table: case_01.user
CREATE TABLE `user` (
  `id` int NOT NULL AUTO_INCREMENT,
