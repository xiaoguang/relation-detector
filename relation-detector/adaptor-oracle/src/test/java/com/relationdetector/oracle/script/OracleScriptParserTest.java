...
class OracleScriptParserTest {
    ...
    void usesStandaloneSlashAsObjectTerminatorOnly() {
        var result = new OracleScriptParser().parse(new ScriptParseRequest("""
    ...
    void normalizesRoutineDeclarationAndFixtureNamespaceProvenance() {
        var declared = new OracleScriptParser().parse(new ScriptParseRequest("""
        ...
        var marked = new OracleScriptParser().parse(new ScriptParseRequest("""
