...
/**
 * CN: 将 Oracle 21c generated root 与 21c typed adapter 交给共享 per-parse collector，返回 structured events；只桥接本版本，不解释 SQL 文本。
 * EN: Connects an Oracle 21c generated root and 21c typed adapter to the shared per-parse collector and returns structured events, bridging only this version without interpreting SQL text.
 */
