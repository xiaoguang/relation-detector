...
import com.relationdetector.oracle.fullgrammer.v12c.OracleFullGrammerParser;
import com.relationdetector.oracle.fullgrammer.v12c.OracleFullGrammerParser.*;

final class Oracle12cParseTreeAdapter extends AbstractOracleFullGrammerParseTreeAdapter {
    Oracle12cParseTreeAdapter() {
        super(Map.of(Symbol.PRIMARY, OracleFullGrammerParser.PRIMARY, Symbol.UNIQUE, OracleFullGrammerParser.UNIQUE,
                        Symbol.IN, OracleFullGrammerParser.IN, Symbol.NOT, OracleFullGrammerParser.NOT,
                        Symbol.EXISTS, OracleFullGrammerParser.EXISTS, Symbol.LEFT, OracleFullGrammerParser.LEFT,
                        Symbol.RIGHT, OracleFullGrammerParser.RIGHT, Symbol.FULL, OracleFullGrammerParser.FULL,
                        Symbol.CROSS, OracleFullGrammerParser.CROSS, Symbol.EQUAL, OracleFullGrammerParser.EQUALS_OP),
                ...
                role(Role.CREATE_TABLE, Create_tableContext.class),
                role(Role.ALTER_TABLE, Alter_tableContext.class),
                ...
                role(Role.FOREIGN_KEY, Foreign_key_clauseContext.class),
                role(Role.CREATE_INDEX, Create_indexContext.class),
                role(Role.SELECT_STATEMENT, Select_statementContext.class),
                role(Role.QUERY_BLOCK, Query_blockContext.class),
                role(Role.TABLE_REF_AUX, Table_ref_auxContext.class),
                role(Role.TABLE_REF_INTERNAL, Table_ref_aux_internal_oneContext.class,
                        Table_ref_aux_internal_threContext.class),
                role(Role.GENERAL_TABLE_REF, General_table_refContext.class),
                role(Role.SELECTED_TABLEVIEW, Selected_tableviewContext.class),
                role(Role.JOIN_CLAUSE, Join_clauseContext.class),
                role(Role.JOIN_ON, Join_on_partContext.class),
                role(Role.JOIN_USING, Join_using_partContext.class),
                role(Role.WHERE_CLAUSE, Where_clauseContext.class),
                role(Role.GROUP_BY_ELEMENT, Group_by_elementsContext.class),
                ...
                role(Role.SUBQUERY, SubqueryContext.class),
                role(Role.COLUMN_REFERENCE, Column_nameContext.class, Table_elementContext.class),
                role(Role.GENERAL_ELEMENT, General_elementContext.class),
                ...
                role(Role.FUNCTION_ARGUMENT, Function_argumentContext.class), role(Role.QUERY_NAME, Query_nameContext.class),
