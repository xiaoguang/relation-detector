...
/**
 * CN: 将 Oracle 26ai generated root 与 26ai typed adapter 交给共享 per-parse collector，返回 structured events；只桥接本版本，不解释 SQL 文本。
 * EN: Connects an Oracle 26ai generated root and 26ai typed adapter to the shared per-parse collector and returns structured events, bridging only this version without interpreting SQL text.
 */
