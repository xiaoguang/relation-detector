...
class FullGrammarStructuredSqlParserFactoryTest {
    @Test
    void createsSelectedFullGrammarParserWithProfileDiagnostic() {
        FullGrammarStructuredSqlParserFactory.CreatedParser created =
                FullGrammarStructuredSqlParserFactory.create(
    ...
    private static final class FakeModule implements FullGrammarDialectModule {
