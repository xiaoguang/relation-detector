 ...
 */
public record ParserObservationFingerprint(
        String factKind,
        ...
        String conditions
) implements Comparable<ParserObservationFingerprint> {
    public static List<ParserObservationFingerprint> relationships(RelationshipCandidate candidate) {
        return relationships(candidate, CanonicalEndpointKeyProvider.defaults());
    }

    public static List<ParserObservationFingerprint> relationships(
            RelationshipCandidate candidate,
            CanonicalEndpointKeyProvider endpointKeys
    ) {
        List<ParserObservationFingerprint> result = new ArrayList<>();
    ...
    public static List<ParserObservationFingerprint> lineages(DataLineageCandidate candidate) {
        return lineages(candidate, CanonicalEndpointKeyProvider.defaults());
    }

    public static List<ParserObservationFingerprint> lineages(
    ...
    @Override
    public int compareTo(ParserObservationFingerprint other) {
