...
final class SourceLocationSupport {
    ...
    SourceLocationSupport(SqlStatementRecord statement, FullGrammerParseTreeAdapter parseTreeAdapter) {
    ...
    String clean(String raw) {
        List<String> parts = FullGrammerIdentifiers.qualifiedParts(raw);
        return parts.isEmpty() ? FullGrammerIdentifiers.clean(raw) : String.join(".", parts);
    }
