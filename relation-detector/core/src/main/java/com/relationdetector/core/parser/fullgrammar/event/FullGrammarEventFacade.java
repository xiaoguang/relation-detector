...
import com.relationdetector.core.parser.fullgrammar.event.WriteMappingSink;
...
import com.relationdetector.core.parser.fullgrammar.event.PredicateEventSink;
 ...
 */
public final class FullGrammarEventFacade {
    ...
    public FullGrammarEventFacade(
        ...
        this.recorder = new FullGrammarEventRecorder(statement, source);
    ...
    public FullGrammarParseTreeAdapter parseTreeAdapter() {
    ...
    public void directProjection(
        ...
        FullGrammarExpressionAnalysis analysis = new FullGrammarExpressionAnalysis(
