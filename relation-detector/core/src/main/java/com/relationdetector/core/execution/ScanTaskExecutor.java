...
import com.relationdetector.core.scan.SourceCollectorPipeline;
 ...
 */
public final class ScanTaskExecutor implements AutoCloseable {
    private static final AtomicInteger POOL_IDS = new AtomicInteger();

    private final ExecutorService executor;

    public ScanTaskExecutor(int parallelism) {
