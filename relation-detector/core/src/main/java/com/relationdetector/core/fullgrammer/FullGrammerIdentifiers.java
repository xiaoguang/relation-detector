...
public final class FullGrammerIdentifiers {
    private FullGrammerIdentifiers() {
    }

    public static Optional<FullGrammerColumnReference> columnReference(String raw) {
        ...
        return column.isBlank()
                ? Optional.empty()
                : Optional.of(new FullGrammerColumnReference(qualifier, column));
    }
