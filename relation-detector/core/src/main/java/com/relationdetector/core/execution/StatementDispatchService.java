 ...
 */
public final class StatementDispatchService {
    public DdlFileDispatch dispatchDdlFile(List<SqlStatementRecord> statements, DatabaseType databaseType) {
