/**
 * CN: live/offline data profiling 指标、SQL 模板与 evidence 构建。
 *
 * <p>EN: Live/offline data-profiling metrics, SQL templates, and evidence construction.
 ...
 * <p>Forbidden: 不输出 SQL/driver message，组合唯一成员不单独定向 / Must not leak SQL or misuse composite uniqueness.
 */
