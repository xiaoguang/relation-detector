...
/**
 * Declares which event families a full-grammar profile is expected to provide natively.
 *
 * <p>CN: 这里是 full-grammar profile 的能力声明，供 parser attributes 使用。
 * 它不生成事件，也不决定 relationship / lineage 语义。</p>
 *
 * <p>EN: This is a capability map for full-grammar parser attributes. It does
 * not emit events and does not decide relationship or lineage semantics.</p>
 */
public final class FullGrammarNativeEventTypes {
    ...
    private FullGrammarNativeEventTypes() {
    }
