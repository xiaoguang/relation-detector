MySQL 5.7 full-grammar profile
==============================

Source: antlr/grammars-v4 `sql/mysql/Oracle`
Commit: `2e36a9dda4b1ef5bdc1c6a7ebe551616ae2da328`

Vendored for the `mysql-5.7` full-grammar parser. The upstream grammar
...
- Java helper/base classes live under
  `com.relationdetector.mysql.fullgrammar.v5_7`.
...
The adaptor keeps a v5.7-local generated-context adapter and visitor. This
