parser grammar MySqlFullGrammerParser;
...
options {
    ...
    tokenVocab = MySqlFullGrammerLexer;
}
...
alterListItem
    ...
    | {this.isServerVersionGe80011()}? ALTER_SYMBOL INDEX_SYMBOL indexRef visibility
...
windowClause
    : {this.isServerVersionGe80011()}? WINDOW_SYMBOL windowDefinition (COMMA_SYMBOL windowDefinition)*
    ;
...
withClause
    : {this.isServerVersionGe80011()}? WITH_SYMBOL RECURSIVE_SYMBOL? commonTableExpression (
...
lockingClause
    : FOR_SYMBOL lockStrengh ({this.isServerVersionGe80031()}? OF_SYMBOL tableAliasRefList)? (
        {this.isServerVersionGe80031()}? lockedRowAction
    )?
...
windowingClause
    : {this.isServerVersionGe80011()}? OVER_SYMBOL (windowName | windowSpec)
    ;
...
commonIndexOption
    ...
    | COMMENT_SYMBOL textLiteral
    | {this.isServerVersionGe80011()}? visibility
