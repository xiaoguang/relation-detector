...
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Common_table_exprContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.A_exprContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.A_expr_inContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.C_expr_existsContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.DeletestmtContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Func_asContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Func_alias_clauseContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.In_expr_selectContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.InsertstmtContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Join_qualContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Merge_insert_clauseContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Merge_update_clauseContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.MergestmtContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Set_clauseContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Simple_select_pramaryContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Table_joinContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Table_primaryContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Table_refContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Target_labelContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.Target_starContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParser.UpdatestmtContext;
import com.relationdetector.postgres.fullgrammer.v18.Postgres18FullGrammerParserBaseVisitor;
 ...
 */
final class PostgresFullGrammerParseTreeVisitor extends Postgres18FullGrammerParserBaseVisitor<Void> {
    ...
    PostgresFullGrammerParseTreeVisitor(SqlStatementRecord statement, List<?> visibleTokens) {
        ...
        this.core = new PostgresSqlEventVisitorCore(statement, new Postgres18ParseTreeAdapter());
        this.sink = core.sink();
    }
