...
/**
 * CN: 使用 PostgreSQL 16 PL/pgSQL shell grammar 定位 static SQL，并仅回调 v16 full-grammar SQL parser。
 * EN: Uses the PostgreSQL 16 PL/pgSQL shell grammar to locate static SQL and calls only the v16 full-grammar parser.
 */
