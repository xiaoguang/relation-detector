...
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.CreatefunctionstmtContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.CreatestmtContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Common_table_exprContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.A_exprContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.A_expr_andContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.A_expr_inContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.C_expr_existsContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Case_exprContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.DeletestmtContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Func_asContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Func_alias_clauseContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.In_expr_selectContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.InsertstmtContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Join_qualContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Merge_insert_clauseContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Merge_update_clauseContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.MergestmtContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Set_clauseContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Select_clauseContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Select_with_parensContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Target_elContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Simple_select_pramaryContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Table_joinContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Table_primaryContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Table_refContext;
import com.relationdetector.postgres.fullgrammar.v17.PostgresFullGrammarParser.Target_labelContext;
...
/**
 * CN: 直接遍历 PostgreSQL 17 generated contexts 并调用 v17 PL/pgSQL shell；共享 helper 只处理无 generated 依赖语义，不跨版本或 token-event delegate。
 * EN: Traverses PostgreSQL 17 generated contexts directly and invokes only the v17 PL/pgSQL shell. Shared helpers remain parser-neutral; no cross-version or token-event delegation occurs.
 */
