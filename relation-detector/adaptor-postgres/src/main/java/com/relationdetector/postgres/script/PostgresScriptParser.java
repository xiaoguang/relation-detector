...
import com.relationdetector.core.script.StructuredScriptParser;

public final class PostgresScriptParser implements DialectScriptParser {
    @Override
    public ScriptParseResult parse(ScriptParseRequest request) {
        ...
        return new StructuredScriptParser().parse(request, tokens, ScriptDialect.POSTGRESQL);
    }
