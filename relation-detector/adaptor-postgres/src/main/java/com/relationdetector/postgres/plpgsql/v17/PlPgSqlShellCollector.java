...
/**
 * CN: 遍历 PostgreSQL 17 PL/pgSQL shell contexts，输出 symbols 和 static SQL boundaries 给 v17 SQL parser；不复制 SQL 子语法或调用其它版本。
 * EN: Traverses PostgreSQL 17 PL/pgSQL shell contexts and returns symbols plus static-SQL boundaries to the v17 SQL parser, without duplicating SQL grammar or invoking another version.
 */
