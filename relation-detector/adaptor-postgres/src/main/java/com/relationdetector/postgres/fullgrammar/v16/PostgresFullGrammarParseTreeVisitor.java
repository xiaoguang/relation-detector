...
/**
 * CN: 直接遍历 PostgreSQL 16 generated contexts 并调用 v16 PL/pgSQL shell；共享 helper 只处理无 generated 依赖语义，不跨版本或 token-event delegate。
 * EN: Traverses PostgreSQL 16 generated contexts directly and invokes only the v16 PL/pgSQL shell. Shared helpers remain parser-neutral; no cross-version or token-event delegation occurs.
 */
