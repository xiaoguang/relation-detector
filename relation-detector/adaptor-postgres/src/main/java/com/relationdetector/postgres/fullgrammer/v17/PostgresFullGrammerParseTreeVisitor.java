...
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.A_expr_inContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.C_expr_existsContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.DeletestmtContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.Func_asContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.Func_alias_clauseContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.In_expr_selectContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.InsertstmtContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.Join_qualContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.Merge_insert_clauseContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.Merge_update_clauseContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.MergestmtContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.Set_clauseContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.Simple_select_pramaryContext;
import com.relationdetector.postgres.fullgrammer.v17.Postgres17FullGrammerParser.Table_joinContext;
 ...
 */
final class PostgresFullGrammerParseTreeVisitor extends Postgres17FullGrammerParserBaseVisitor<Void> {
    ...
    PostgresFullGrammerParseTreeVisitor(SqlStatementRecord statement, List<?> visibleTokens) {
        ...
        this.core = new PostgresSqlEventVisitorCore(statement, new Postgres17ParseTreeAdapter());
        this.sink = core.sink();
    }
