...
/**
 * PostgreSQL 18 generated grammar binding.
 *
 * <p>CN: 这是 v18 package 的薄桥接层，只暴露 generated lexer/parser、SQL typed
 * visitor 和 DDL collector 给 common parser。
 *
 * <p>EN: Thin bridge for the v18 package. It exposes the generated lexer/parser,
...
final class PostgresFullGrammerVersionBinding implements PostgresFullGrammerSqlBinding, PostgresFullGrammerDdlBinding {
    ...
    private final PostgresFullGrammerDdlEventCollector ddlCollector = new PostgresFullGrammerDdlEventCollector(PostgresDdlVersionPolicy.temporalAware());
    ...
    public String lexerName() {
        return Postgres18FullGrammerLexer.class.getSimpleName();
    }

    @Override
    public String parserName() {
        return Postgres18FullGrammerParser.class.getSimpleName();
    }
    ...
    public FullGrammerSqlParse parseSql(String sql) {
        return PostgresFullGrammerParseSupport.parseSql(
                sql,
                Postgres18FullGrammerLexer::new,
                Postgres18FullGrammerParser::new,
                Postgres18FullGrammerParser::root);
    }
