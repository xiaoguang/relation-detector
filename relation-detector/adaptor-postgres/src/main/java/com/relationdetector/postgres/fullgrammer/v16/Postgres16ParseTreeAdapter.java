...
import com.relationdetector.postgres.fullgrammer.v16.Postgres16FullGrammerParser.*;

final class Postgres16ParseTreeAdapter extends AbstractFullGrammerParseTreeAdapter {
    Postgres16ParseTreeAdapter() {
        super(
