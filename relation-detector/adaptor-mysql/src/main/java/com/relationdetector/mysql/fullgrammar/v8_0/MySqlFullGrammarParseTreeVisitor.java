...
/**
 * CN: 直接遍历 MySQL 8.0 generated contexts，提取 rowset、predicate、projection、write、routine 和 DDL events；公共无状态语义下沉到 common helper，但不跨版本 delegate。
 * EN: Traverses MySQL 8.0 generated contexts directly to emit rowset, predicate, projection, write, routine, and DDL events. Stateless semantics may be shared, but parser traversal never delegates across versions.
 */
