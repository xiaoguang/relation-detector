...
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.CommonTableExpressionContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.CaseValueExpressionContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.CreateTableContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.CreateTriggerContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.DeleteStatementContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.DerivedTableContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.EscapedTableReferenceContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.ExprAndContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.FunctionParameterContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.InsertStatementContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.JoinedTableContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.PredicateExprInContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.PredicateContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.PrimaryExprCompareContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.ProcedureParameterContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.QuerySpecificationContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.SelectItemContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.SimpleExprSubQueryContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.SingleTableContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.TableFunctionContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.TableReferenceContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.UpdateElementContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.UpdateStatementContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.VariableDeclarationContext;
import com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParserBaseVisitor;
import org.antlr.v4.runtime.ParserRuleContext;
import org.antlr.v4.runtime.tree.ParseTree;

/**
 * MySQL 5.7 full-grammar SQL parse-tree visitor。
 *
 ...
 *
 * <p>EN: MySQL 5.7 full-grammar SQL parse-tree visitor. It emits
...
final class MySqlFullGrammarParseTreeVisitor extends MySqlFullGrammarParserBaseVisitor<Void> {
    ...
    private void rememberSelectIntoVariables(
            com.relationdetector.mysql.fullgrammar.v5_7.MySqlFullGrammarParser.IntoClauseContext ctx
    ) {
    ...
    public Void visitPrimaryExprCompare(PrimaryExprCompareContext ctx) {
        if (ownedJoinPredicateDepth == 0
                && ctx.compOp() != null && ctx.compOp().EQUAL_OPERATOR() != null) {
            if (core.inExists()) {
