...
class MySqlFullGrammarGeneratedParserSmokeTest {
    @Test
    void generatedParserParsesSimpleSelect() {
        MySqlFullGrammarLexer lexer = new MySqlFullGrammarLexer(CharStreams.fromString("SELECT 1;"));
        MySqlFullGrammarParser parser = new MySqlFullGrammarParser(new CommonTokenStream(lexer));
    ...
    void generatedParserParsesBasicDdl() {
        MySqlFullGrammarLexer lexer = new MySqlFullGrammarLexer(CharStreams.fromString("""
                CREATE TABLE orders (
